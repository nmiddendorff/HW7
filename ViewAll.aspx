<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="ViewAll.aspx.vb" Inherits="ViewAll" %>
...
<p>
    <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="VIN" DataSourceID="SqlDataSource1" HorizontalAlign="Center" Width="295px">
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="VIN" DataNavigateUrlFormatString="details.aspx?VIN={0}" HeaderText="Details" Text="Select" />
        </Columns>
    </asp:GridView>
</p>
<p>
